...
NEXT_PUBLIC_ADMIN_EMAIL=Thessah.com@gmail.com
```
...
- **Note:** For production, verify your domain with Resend to use custom email like `noreply@Thessah.com`
...
1. **Verify Domain with Resend:**
   ...
   - Add your domain (e.g., Thessah.com)
   - Add DNS records as instructed
   - Update `EMAIL_FROM` to `noreply@Thessah.com`
